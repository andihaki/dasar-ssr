...
exports.default = [_extends({}, _App2.default, { //always display on page, cause there's no 'path:' defined
...
//this case, used for authentication
...
app.use(_express2.default.static('public')); //public folder dibaca sebagai static resource
...
//argument req & store, get from index.js (server)
//renderToString = untuk SSR
//SERVER side
exports.default = function (req, store, context) {
  //context = required by Static router, untuk handle redirect & error handling
...
exports.default = function (req) {
  var axiosInstance = _axios2.default.create({
    ...
    headers: { cookie: req.get('cookie') || '' //ga ada cookie? isi blank
    } });
...
//exporting object with component of Home
exports.default = {
  component: Home
};
